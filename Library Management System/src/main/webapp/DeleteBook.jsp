...
<div class="form-wrapper">
    <form action="bookcontroller" method="post" onsubmit="return confirm('Are you sure you want to delete this book?');">
        <h2>Delete Book</h2>
        <label for="id">Book ID</label>
        <input type="number" name="id" id="id" placeholder="Enter book ID" required>
        <input type="submit" name="action" value="Delete" title="Delete this book">
        
        <div class="text-center">
           <a href="dashboard_Admin.jsp">← Back </a>
       </div>
    </form>
</div>
